...
<b>私有属性、变量</b>和方法以下划线 \_ 开头。

```javascript
var _privateMethod = {};
```

<b>常量</b>使用全部字母大写，单词间下划线分隔的命名方式。

```javascript
var HTML_ENTITY = {};
```

1.  <b>函数</b>, 使用 Camel 命名法。
2.  函数的<b>参数</b>, 使用 Camel 命名法。
...
1.  <b>类</b>, 使用 Camel 命名法。
2.  类的<b>方法/属性</b>, 使用 Camel 命名法。
...
1.  <b>枚举变量</b>, 使用 Camel 命名法。
2.  <b>枚举的属性</b>, 使用全部字母大写，单词间下划线分隔的命名方式。
...
由多个单词组成的 <b>缩写词</b>，在命名中，根据当前命名法和出现的位置，所有字母的大小写与首字母的大小写保持一致。
...
<b>boolean</b>，类型的变量使用 is 或 has 开头。
...
操作符始终写在前一行, 以免<b>分号的隐式插入</b>产生预想不到的问题。
...
<a href="性能优化.md">性能优化</a> | <a href="JS性能优化.md">JS 性能优化</a>
